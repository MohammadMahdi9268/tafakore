...
function AllCourses() {
  ...
  return (
    <div className="container mx-auto px-7 py-12">
      <h2 className="text-4xl font-bold text-black mb-14 text-center">دوره‌های آموزشی</h2>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-800 transition duration-300"
              >
                حذف
              </button>
            </div>
